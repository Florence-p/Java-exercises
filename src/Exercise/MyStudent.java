...
public class MyStudent {
    public static void main(String[] args) {
        ...
        MyStudent2 students2 = new MyStudent2("Scooby", 18, "200 Level", 50);
        ...
        MyStudent2 foundStudent = school.getStudentByName(students);

        if (foundStudent != null) {
            System.out.println("\n--- Student Result ---");
            foundStudent.displayInfo();
            System.out.println("Status: " + (foundStudent.hasPassed() ? "Passed" : "Failed"));
